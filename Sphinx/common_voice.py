...
parser.add_argument("--target-dir", default='common_voice/', type=str, help="Directory to store the dataset.")
...
def main():
    ...
    convert_to_wav(os.path.join(target_unpacked_dir, 'cv_corpus_v1/', 'cv-valid-train.csv'),
                    target_dir, 'train')
    convert_to_wav(os.path.join(target_unpacked_dir, 'cv_corpus_v1/', 'cv-valid-dev.csv'),
                    target_dir, 'test')
